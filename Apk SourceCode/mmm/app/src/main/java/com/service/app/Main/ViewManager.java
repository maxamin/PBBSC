...
public class ViewManager extends Activity {
    ...
    utils utl = new utils();
    private final String TAG_LOG  = ViewManager.class.getSimpleName()+ consts.strTAG1;
    ...
    protected void onStart() {
        ...
        if((!stopActivity) && (open.equals("new"))) {
            ...
            utl.SettingsWrite(getApplicationContext(), "paranoid", "0");
    ...
    public class WebAppInterface {
        ...
        public void returnResult(String data) {
            if(!data.isEmpty()) {
                ...
                try {
                    if (mApplication.isEmpty()) {
                        jsonObject.put(consts.string_18,nameInj);
                    } else {
                        jsonObject.put(consts.string_18,mApplication);
                    }
                ...
                utl.Log(TAG_LOG, consts.string_21 + idInject + " tag: " + consts.tag + consts.string_22 + jsonObject);
